...
if nargin ~= 1
    %colorImage = imread('NumberPlate5.jpg');
    colorImage = imread('NumberPlate.jpg');
    else
    colorImage = img;
end
...
filterIdx = filterIdx | [mserStats.Eccentricity] > .995 ; % .995
...
% Show the final text detection result.
 ...
 imshow(ITextRegion);
textBBoxes = sortrows(textBBoxes,1);
save('test.mat','textBBoxes');
textBBoxes;
