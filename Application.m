...
% Last Modified by GUIDE v2.5 18-Apr-2016 23:02:46
...
fclose(fileID);
close(conn);
set(handles.edit3, 'String', num2str(bno));
set(handles.edit2, 'String', num2str(cno));
...
guidata(hObject);
 imshow('logo.jpg','Parent',handles.axes2);
 set(handles.edit4, 'String', num2str(output1));
